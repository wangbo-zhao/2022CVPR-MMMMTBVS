...
def a2d_evaluate(args, model, data_loader, device, iterations, output_dir):
    model.eval()
...
if __name__ == '__main__':
    ...
    dataset_test = A2DTestDataset(para, a2d_dataset_root)
    ...
    mean_iou, overall_iou, precision5, precision6, precision7, precision8, precision9, precision_mAP, total_time = a2d_evaluate(args=para, model=model, data_loader=data_loader_test, device=device, iterations=iterations,
