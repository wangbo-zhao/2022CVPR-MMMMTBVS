...
class VisionModel(nn.Module):
    def __init__(self, backbone_name, pretrained_dir=None):
        super(VisionModel, self).__init__()
        backbone = resnet.__dict__[backbone_name](
            pretrained=False,
            replace_stride_with_dilation=[False, False, True])
        if pretrained_dir is not None:
            pretrained_state = torch.load(pretrained_dir)
...
def ResNet34(nInputChannels=3, os=32, pretrained=True, model_path='./pre_train/resnet34-333f7ec4.pth'):
    model = ResNet(nInputChannels, BasicBlock, [3, 4, 6, 3], os,
                    pretrained=pretrained, model_path=model_path)
    return model

def ResNet101(nInputChannels=3, os=32, pretrained=True, model_path='/home/hadoop-automl/cephfs/data/zhaowangbo/tools/torch/hub/checkpoints/resnet101-5d3b4d8f.pth'):
    model = ResNet(nInputChannels, Bottleneck, [3, 4, 23, 3], os,
                    pretrained=pretrained, model_path=model_path)
    return model

# backbone_features34 = ResNet34(nInputChannels=3, os=16, pretrained=True, model_path="/home/hadoop-automl/cephfs/data/zhaowangbo/tools/torch/hub/checkpoints/resnet34-333f7ec4.pth")
# backbone_features101 = ResNet101(nInputChannels=3, os=16, pretrained=True, model_path="/home/hadoop-automl/cephfs/data/zhaowangbo/tools/torch/hub/checkpoints/resnet101-5d3b4d8f.pth")
