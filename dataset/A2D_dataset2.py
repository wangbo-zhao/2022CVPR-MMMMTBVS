...
class A2DTestDataset(Dataset):
    def __init__(self, args, root):
        ...
        for test_sample in test_list:
            ...
            for i in range(1, len(sentence_raw_split)):
                sentence_raw_split_ = sentence_raw_split[0:i + 1]
                sentence_raw_split_ = sentence_raw_split_[:max_tokens - 2]
                input_ids = self.tokenizer.encode(text=sentence_raw_split_, add_special_tokens=True)
                ...
                self.objects_list.append(
                    {"name": sequence_name + "___" + k,
                     ...
                     "sentence_raw": sentence_raw_split_,
